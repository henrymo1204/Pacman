...
class Game:
    def __init__(self):
        ...
        self.blinky = Ghost(game=self, v=Vector(0, 0), pt=self.stars6[3].pt, grid_pt_next=self.stars6[3],
                            grid_pt_prev=self.stars6[3], pacman=self.pacman, stars=self.stars_stars)
        self.pinky = Ghost(game=self, v=Vector(0, 0), pt=self.stars5[4].pt, grid_pt_next=self.stars5[4],
                           grid_pt_prev=self.stars5[4], pacman=self.pacman, stars=self.stars_stars)
        self.inkey = Ghost(game=self, v=Vector(0, 0), pt=self.stars5[5].pt, grid_pt_next=self.stars5[5],
                           grid_pt_prev=self.stars5[5], pacman=self.pacman, stars=self.stars_stars)
        self.clyde = Ghost(game=self, v=Vector(0, 0), pt=self.stars5[6].pt, grid_pt_next=self.stars5[6],
                           grid_pt_prev=self.stars5[6], pacman=self.pacman, stars=self.stars_stars)
        self.ghosts = [self.blinky, self.pinky, self.inkey, self.clyde]
